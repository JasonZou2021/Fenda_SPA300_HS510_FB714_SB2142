...
/*! Callback to send frame the QS trace data to the host */
/**
* @description
...
/*! Callback to Force Flush the QS trace data to the host */
/**
* @description
* This is a platform-dependent "callback" function to flush the QS trace
* buffer to the host. The function typically busy-waits until all the data
...
* transient.
*/
void QS_onForce(void);

/*! Callback to wake up  tx thread to flush */
/**
* @description
* This is a platform-dependent "callback" function to flush the QS trace
* buffer to the host. The function typically busy-waits until all the data
...
* @note Must always be used in pair with #QS_END
*/
#define QS_BEGIN_NO_LOCK(rec_, obj_) \
    if ((((uint_fast8_t)QS_priv_.glbFilter[(uint8_t)(rec_) >> 3] \
        & (uint_fast8_t)((uint_fast8_t)1 << ((uint8_t)(rec_) & (uint8_t)7))) \
            != (uint_fast8_t)0) \
        && ((QS_priv_.apObjFilter == (void *)0) \
...
void QS_uartIntrTimer2BRX(void);
void QS_timer2BIntrForRX(void);
