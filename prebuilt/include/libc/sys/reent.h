...
struct _reent
{
	...
	unsigned char _enable_print_counter;	/* enable printchar counter */
	unsigned short _max_print_counter;	/* assigned by arg 2 of snprintf or vsnprintf .etc */
	unsigned short _print_counter; /* printe counter of printchar */
    unsigned char _no_str_tail;
...
#define _REENT_INIT(var) \
	{ /*(__FILE *)&var.__sf_fake, (__FILE *)&var.__sf_fake,*/ \
		/*(__FILE *)&var.__sf_fake,*/ 0, 0, 0, 0, 0, /*0,*/ /*_NULL,*/ /*0,*/ /*0,*/ \
...
#define _REENT_INIT_PTR(var) \
	{ /*var->_stdin = (__FILE *)&var->__sf_fake;*/ \
		...
		var->_errno = 0; \
		var->_enable_print_counter = 0; \
		var->_max_print_counter = 0; \
		var->_print_counter = 0; \
		var->_no_str_tail = 0; \
		/*var->_inc = 0; */\
		...
		/* var->_getdate_err = 0; never use this line*/\
