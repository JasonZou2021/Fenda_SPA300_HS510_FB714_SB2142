...
#define CUST_CUSTOMER_CODE   (0xbfa4)   //(0x007F) //for other sunplus IR controller
#define CUST_POWER_KEY_CODE  0x40// (0x46)
...
#define USER_PROJECT_SUPPORT_BT_MODE		(1)
	...
	//#define MCU_IF_FEATURE // for sunplus solution use

	//#define MCU_IF_CUSTOMER  // for customer solution use
	//#define MCU_IF_SP
