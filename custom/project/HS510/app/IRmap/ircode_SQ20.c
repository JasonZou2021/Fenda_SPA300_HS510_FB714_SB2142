...
const BYTE ir_mapcode[] =
{
	...
	IRC_NULL,			IRC_MUTE,		IRC_NULL,	IRC_NULL,	//0x0c, 0x0d ,0x0e, 0x0f

	IRC_VOLUME_UP,			IRC_VOLUME_DN,			IRC_NULL,	IRC_NULL,	//0x10, 0x11 ,0x12, 0x13
	IRC_NULL,			IRC_DOLBY,			IRC_NULL,	IRC_NULL,	//0x14, 0x15 ,0x16, 0x17
	...
	IRC_PLAY,			IRC_NULL,			IRC_NULL,       	IRC_NULL,	//0x2c, 0x2d ,0x2e, 0x2f
	...
	IRC_NULL,			IRC_NULL,			IRC_DOLBY,		IRC_NULL,	//0x50, 0x51 ,0x52, 0x53
	IRC_NULL,			IRC_NULL,			IRC_NULL,		IRC_NULL,	//0x54, 0x55 ,0x56, 0x57
	IRC_UP,			IRC_DOWN,			IRC_PREV,		IRC_NEXT,	//0x58, 0x59 ,0x5a, 0x5b
	IRC_NULL,		IRC_NULL,			IRC_NULL,		IRC_NULL,	//0x5c, 0x5d ,0x5e, 0x5f

	IRC_NULL,			IRC_NULL,			IRC_NULL,		IRC_NULL,	//0x60, 0x61 ,0x62, 0x63
	IRC_WOOFER_VOL_UP,			IRC_WOOFER_VOL_DOWN,			IRC_NULL,		IRC_NULL,	//0x64, 0x65 ,0x66, 0x67
	...
	IRC_NULL,			IRC_NULL,			IRC_NULL,		IRC_RETURN,	//0x80, 0x81 ,0x82, 0x83
	...
	IRC_NULL,			IRC_NULL,			IRC_NULL,		IRC_POWER,	//0xc4, 0xc5 ,0xc6, 0xc7
	IRC_NULL,			IRC_NULL,			IRC_NULL,		IRC_NULL,	//0xc8, 0xc9 ,0xca, 0xcb
	IRC_NULL,			IRC_MENU,			IRC_NULL,		IRC_NULL,	//0xcc, 0xcd ,0xce, 0xcf
